...
//Setting for express app to understand that we are using templete engines
...
app.get("/players", (req, res, next) =>{
  const players = [
    ...
    },
    {
      ...
      lastName: "James",
      team: "CLE",
      photo: "https://www.tampabay.com/resizer//gdBh9bVe6etQ8nyefD7G0XnqQ9c=/1140x641/smart/cloudfront-us-east-1.images.arcpublishing.com/tbt/6BSL5DHGARD45N3VMGYFDYFA74.jpg",
      average: [
        { year: 2013, points: 78 },
        { year: 2014, points: 82 },
        { year: 2015, points: 76 },
